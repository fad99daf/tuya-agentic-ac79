...
/* This callback runs in the iot_client_process caller's task. Applications
 * must defer VM writes, deinit and reboot to their owning task. */
typedef enum {
...
typedef struct {
    ...
    iot_reset_callback_t reset_callback; // Cloud reset callback
